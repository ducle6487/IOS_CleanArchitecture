...
public struct WalkthroughView: View {
    ...
    @State private var childSize: CGSize = .init(width: 1, height: 1)
...
struct WalkthroughView_Previews: PreviewProvider {
    struct Wrapper: View {
        ...
        @State var currentTabSelection: UUID = .init()
        ...
        var body: some View {
            ...
            .task {
                let lottie = try? await DotLottieFile.loadedFrom(
                    url: URL(string: "https://lottie.host/c956b8dd-0410-4b1d-8b41-580efea6077b/EPA9QX7rZS.lottie")!
                )
                steps = [
                    WalkthroughStep(
