...
public extension CombustionButtonType {
    // MARK: - Primary Conveniences

    /// Convenience accessor for secondary button type without a parameter
    static var primary: CombustionButtonType {
        primary()
    }
    
    static func primary(onSurface: Bool = false) -> CombustionButtonType {
        ._primary(onSurface)
    }
    ...
    /// Convenience accessor for secondary button type without a parameter
    static var secondary: CombustionButtonType {
        secondary()
    }
    
    static func secondary(onSurface: Bool = false) -> CombustionButtonType {
    ...
    /// Convenience accessor for secondary button type without a parameter
    static var tertiary: CombustionButtonType {
        tertiary()
    }
    
    static func tertiary(onSurface: Bool = false) -> CombustionButtonType {
        ._tertiary(onSurface)
    }
}
